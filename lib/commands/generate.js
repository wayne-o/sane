...
var singular = _require2.singular;
 ...
 * These tasks are usually related to generating code, copying over files,
    ...
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 5:
        ...
        if (name !== undefined) {
          ...
          sailsOptions = ['generate', 'model', singular(name)].concat(modelConversion.toSails(attributes));
